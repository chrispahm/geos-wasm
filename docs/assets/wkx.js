...
var Types = wkx.Types = types;
var Geometry = wkx.Geometry = requireGeometry();
var Point = wkx.Point = requirePoint();
var LineString = wkx.LineString = requireLinestring();
var Polygon = wkx.Polygon = requirePolygon();
var MultiPoint = wkx.MultiPoint = requireMultipoint();
var MultiLineString = wkx.MultiLineString = requireMultilinestring();
var MultiPolygon = wkx.MultiPolygon = requireMultipolygon();
var GeometryCollection = wkx.GeometryCollection = requireGeometrycollection();

export { Geometry, GeometryCollection, LineString, MultiLineString, MultiPoint, MultiPolygon, Point, Polygon, Types, wkx as default };
