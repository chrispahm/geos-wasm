...
export default function addGEOSFunctions (Module, geos) {
  ...
  /**
   * @param {GEOSContextHandle_t} handle - undefined
   * @returns {null} void
  ...
  /**
   * @param {number} byteOrder - undefined
   * @returns {number} int
  ...
  /**
   * @param {number} newDims - undefined
   * @returns {number} int
   ...
   * Calculate the area of a geometry.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {NumberPointer} area - undefined
   * @returns {number} 1 on success, 0 on exception.
   * @alias module:geos
   */
   ...
   * @param {number} quadsegs - undefined
   * @returns {GEOSGeometry} A GEOSGeometry of the buffered result. NULL on exception. Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   */
   ...
   * Destroy a GEOSBufferParams and free all associated memory.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSBufferParams} parms - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * @param {GEOSBufferParams} p - undefined
   * @param {number} style - undefined
   ...
   * @param {GEOSBufferParams} p - undefined
   * @param {number} joinStyle - undefined
   * @returns {number} 0 on exception, 1 on success.
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSBufferParams} p - undefined
   * @param {number} mitreLimit - undefined
   * @returns {number} 0 on exception, 1 on success.
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSBufferParams} p - undefined
   * @param {number} singleSided - undefined
   * @returns {number} 0 on exception, 1 on success.
   * @alias module:geos
   */
   ...
   * @param {number} width - undefined
   * @param {number} quadsegs - undefined
   * @param {number} endCapStyle - undefined
   * @param {number} joinStyle - undefined
   * @param {number} mitreLimit - undefined
   * @returns {GEOSGeometry} The buffered geometry, or NULL on exception. Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {number} xmin - undefined
   * @param {number} ymin - undefined
   * @param {number} xmax - undefined
   * @param {number} ymax - undefined
   * @returns {GEOSGeometry} The clipped geometry or NULL on exception Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {number} ratio - undefined
   * @param {number} allowHoles - undefined
   * @returns {GEOSGeometry} A newly allocated geometry of the concave hull. NULL on exception.
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {number} lengthRatio - undefined
   * @param {number} isTight - undefined
   * @param {number} isHolesAllowed - undefined
   * @returns {GEOSGeometry} A newly allocated geometry of the concave hull. NULL on exception.
   * @alias module:geos
   */
   ...
   * Tests if geometry g2 is completely within g1, but not wholly contained in the boundary of g1.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g1 - undefined
   * @param {GEOSGeometry} g2 - undefined
   * @returns {number} 1 on true, 0 on false, 2 on exception
   * @alias module:geos
   */
   ...
   * Clone a coordinate sequence.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSCoordSequence} s - undefined
   * @returns {GEOSCoordSequence} a copy of the coordinate sequence or NULL on exception
   * @alias module:geos
   */
   ...
   * Create a coordinate sequence by copying from arrays of doubles
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {NumberPointer} x - undefined
   * @param {NumberPointer} y - undefined
   * @param {NumberPointer} z - undefined
   * @param {NumberPointer} m - undefined
   ...
   * Create a coordinate sequence by copying from an interleaved buffer of doubles (e.g., XYXY or XYZXYZ)
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {NumberPointer} buf - undefined
   * @param {number} size - undefined
   * @param {number} hasZ - undefined
   * @param {number} hasM - undefined
   * @returns {GEOSCoordSequence} the sequence or NULL on exception
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSCoordSequence} s - undefined
   * @param {NumberPointer} dims - undefined
   * @returns {number} 0 on exception
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSCoordSequence} s - undefined
   * @param {number} idx - undefined
   * @param {number} dim - undefined
   * @param {NumberPointer} val - undefined
   * @returns {number} 0 on exception
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSCoordSequence} s - undefined
   * @param {NumberPointer} size - undefined
   * @returns {number} 0 on exception
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSCoordSequence} s - undefined
   * @param {StringPointer} is_ccw - undefined
   * @returns {number} 0 on exception, 1 on success
   * @alias module:geos
   */
  ...
  /**
   * Analyze a coverage (represented as a collection of polygonal geometry with exactly matching edge geometry) to find places where the assumption of exactly matching edges is not met.
   * @param {GEOSContextHandle_t} extHandle - undefined
   * @param {GEOSGeometry} input - undefined
   * @param {number} gapWidth - undefined
   * @param {GEOSGeometry} output - undefined
   * @returns {number} A value of 1 for a valid coverage, 0 for invalid and 2 for an exception or error. Invalidity includes polygons that overlap, that have gaps smaller than the gapWidth, or non-polygonal entries in the input collection.
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} extHandle - undefined
   * @param {GEOSGeometry} input - undefined
   * @param {number} tolerance - undefined
   * @param {number} preserveBoundary - undefined
   * @returns {GEOSGeometry} A collection containing the simplified geometries, or null on error.
   * @alias module:geos
   */
   ...
   * @param {GEOSGeometry} g - undefined
   * @param {number} tolerance - undefined
   * @param {number} onlyEdges - undefined
   * @returns {GEOSGeometry} A newly allocated geometry. NULL on exception. Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   */
   ...
   * @param {GEOSGeometry} g1 - undefined
   * @param {GEOSGeometry} g2 - undefined
   * @param {number} gridSize - undefined
   * @returns {GEOSGeometry} A newly allocated geometry of the difference. NULL on exception. Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   */
   ...
   * @param {GEOSGeometry} g1 - undefined
   * @param {GEOSGeometry} g2 - undefined
   * @param {NumberPointer} dist - undefined
   * @returns {number} 1 on success, 0 on exception.
   * @alias module:geos
   */
   ...
   * @param {GEOSGeometry} g1 - undefined
   * @param {GEOSGeometry} g2 - undefined
   * @param {number} densifyFrac - undefined
   * @param {NumberPointer} dist - undefined
   * @returns {number} 1 on success, 0 on exception.
   * @alias module:geos
   */
   ...
   * Free strings and byte buffers returned by functions such as GEOSWKBWriter_write(), GEOSWKBWriter_writeHEX() and GEOSWKTWriter_write(), etc. If passed a null pointer the function does nothing.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {Pointer} buffer - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * Free the memory associated with a GEOSGeoJSONReader.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeoJSONReader} reader - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeoJSONReader} reader - undefined
   * @param {StringPointer} geojson - undefined
   ...
   * Free the memory associated with a GEOSGeoJSONWriter.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeoJSONWriter} writer - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * @param {GEOSGeometry} geoms - undefined
   * @param {number} ngeoms - undefined
   * @returns {GEOSGeometry} A newly allocated geometry collection. NULL on exception. Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   */
   ...
   * Creates a CompoundCurve geometry.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} curves - undefined
   * @param {number} ncurves - undefined
   * @returns {GEOSGeometry} A newly allocated CompoundCurve geometry. NULL on exception. Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   */
   ...
   * Creates a CurvePolygon geometry from ring geometries.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} shell - undefined
   * @param {GEOSGeometry} holes - undefined
   * @param {number} nholes - undefined
   * @returns {GEOSGeometry} A newly allocated geometry. NULL on exception. Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {NumberPointer} xmin - undefined
   * @param {NumberPointer} ymin - undefined
   * @param {NumberPointer} xmax - undefined
   * @param {NumberPointer} ymax - undefined
   * @returns {number} 1 on success, 0 on exception
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {NumberPointer} value - undefined
   * @returns {number} 0 on exception
   * @alias module:geos
   */
   ...
   * Release the sub-geometries of a collection for management. by the caller. The input collection remains as an empty collection, that the caller is responsible for destroying. The output geometries are also the responsibility of the caller, as is the containing array, which must be freed with GEOSFree().
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} collection - undefined
   * @param {NumberPointer} ngeoms - undefined
   * @returns {GEOSGeometry} A newly allocated array of GEOSGeometry pointers.
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {Pointer} userData - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {GEOSTransformXYCallback} callback - undefined
   * @param {Pointer} userdata - undefined
   * @returns {GEOSGeometry} a copy of the input geometry with transformed coordinates. Caller must free with GEOSGeom_destroy().
   * @alias module:geos
   */
  ...
  /**
   * @param {StringPointer} wkt - undefined
   * @returns {GEOSGeometry} GEOSGeometry*
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {NumberPointer} length - undefined
   * @returns {number} 1 on success, 0 on exception.
   * @alias module:geos
   */
   ...
   * Calculate the Hilbert code of the centroid of a geometry relative to an extent. This allows sorting geometries in a deterministic way, such that similar Hilbert codes are likely to be near each other in two-dimensional space. The caller must ensure that the geometry is contained within the extent.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} geom - undefined
   * @param {GEOSGeometry} extent - undefined
   * @param {number} level - undefined
   * @param {NumberPointer} code - undefined
   * @returns {number} 1 on success, 0 on exception.
   * @alias module:geos
   */
   ...
   * Measuring from start of line, return point that is distance the start. Line parameter must be a LineString. The returned point is not guaranteed to intersect the line due to limitations of floating point calculations.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} line - undefined
   * @param {number} d - undefined
   * @returns {GEOSGeometry} The point GEOSGeometry that is distance from the start of line. Caller takes ownership of returned geometry.
   * @alias module:geos
   */
   ...
   * @param {GEOSGeometry} g - undefined
   * @param {number} flags - undefined
   * @param {Pointer} reason - undefined
   * @param {GEOSGeometry} location - undefined
   * @returns {number} 1 when valid, 0 when invalid, 2 on exception
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {GEOSGeometry} boundary - undefined
   * @param {number} tolerance - undefined
   * @returns {GEOSGeometry} A newly allocated geometry of the LEC radius line. NULL on exception. Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {number} start_fraction - undefined
   * @param {number} end_fdraction - undefined
   * @returns {GEOSGeometry} selected substring. Caller is responsible for freeing with GEOSGeom_destroy()
   * @alias module:geos
   */
   ...
   * Destroy a GEOSMakeValidParams.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSMakeValidParams} parms - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * @param {GEOSMakeValidParams} p - undefined
   * @param {number} keepCollapsed - undefined
   * @returns {number} 0 on exception, 1 on success.
   * @alias module:geos
   */
   ...
   * @param {GEOSMakeValidParams} p - undefined
   * @param {GEOSMakeValidMethods} method - undefined
   * @returns {number} 0 on exception, 1 on success.
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {GEOSMakeValidParams} makeValidParams - undefined
   * @returns {GEOSGeometry} A repaired geometry. Caller must free with GEOSGeom_destroy().
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {NumberPointer} radius - undefined
   * @param {GEOSGeometry} center - undefined
   * @returns {GEOSGeometry} The circle geometry or NULL on exception Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {NumberPointer} distance - undefined
   * @returns {number} 0 if no exception occurred. 2 if an exception occurred.
   * @alias module:geos
   */
   ...
   * For the points formed by the six input ordinates, walking from A to B and then to P.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {number} Ax - undefined
   * @param {number} Ay - undefined
   * @param {number} Bx - undefined
   * @param {number} By - undefined
   * @param {number} Px - undefined
   * @param {number} Py - undefined
   * @returns {number} -1 if reaching P takes a counter-clockwise (left) turn, 1 if reaching P takes a clockwise (right) turn, 0 if P is collinear with A-B
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {number} exteriorCW - undefined
   * @returns {number} 0 on success or -1 on exception
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {number} isOuter - undefined
   * @param {number} vertexNumFraction - undefined
   * @returns {GEOSGeometry} A newly allocated geometry of the concave hull. NULL on exception.
   * @alias module:geos
   */
   ...
   * @param {GEOSGeometry} g - undefined
   * @param {number} isOuter - undefined
   * @param {number} parameterMode - undefined
   * @param {number} parameter - undefined
   * @returns {GEOSGeometry} A newly allocated geometry of the concave hull. NULL on exception.
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} input - undefined
   * @param {GEOSGeometry} cuts - undefined
   * @param {GEOSGeometry} dangles - undefined
   * @param {GEOSGeometry} invalidRings - undefined
   * @returns {GEOSGeometry} The polygonal valid output Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   */
   ...
   * Use a GEOSPreparedGeometry do a high performance calculation of whether the provided geometry is contained.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSPreparedGeometry} pg1 - undefined
   * @param {GEOSGeometry} g2 - undefined
   * @returns {number} 1 on true, 0 on false, 2 on exception
   * @alias module:geos
   */
   ...
   * Free the memory associated with a GEOSPreparedGeometry. Caller must separately free the base GEOSGeometry used to create the prepared geometry.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSPreparedGeometry} g - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * @param {GEOSPreparedGeometry} pg1 - undefined
   * @param {GEOSGeometry} g2 - undefined
   * @param {StringPointer} im - undefined
   * @returns {number} 1 on true, 0 on false, 2 on exception
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} line - undefined
   * @param {GEOSGeometry} point - undefined
   * @returns {number} distance along line that point projects to, -1 on exception
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {GEOSGeometry} p - undefined
   * @returns {number} The proportion of the overall line length that the projected point falls at.
   * @alias module:geos
   */
   ...
   * @param {GEOSGeometry} g1 - undefined
   * @param {GEOSGeometry} g2 - undefined
   * @param {StringPointer} imPattern - undefined
   * @returns {number} 1 on true, 0 on false, 2 on exception
   * @alias module:geos
   */
   ...
   * Compare a DE9IM string to a pattern and return true if they are consistent.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {StringPointer} intMatrix - undefined
   * @param {StringPointer} imPattern - undefined
   * @returns {number} 1 on true, 0 on false, 2 on exception
   * @alias module:geos
   */
   ...
   * Computes the coordinate where two line segments intersect, if any
   * @param {GEOSContextHandle_t} extHandle - undefined
   * @param {number} ax0 - undefined
   * @param {number} ay0 - undefined
   * @param {number} ax1 - undefined
   * @param {number} ay1 - undefined
   * @param {number} bx0 - undefined
   * @param {number} by0 - undefined
   * @param {number} bx1 - undefined
   * @param {number} by1 - undefined
   * @param {NumberPointer} cx - undefined
   * @param {NumberPointer} cy - undefined
   * @returns {number} 0 on error, 1 on success, -1 if segments do not intersect
   * @alias module:geos
   */
   ...
   * @param {number} joinStyle - undefined
   * @param {number} mitreLimit - undefined
   * @param {number} leftSide - undefined
   * @returns {GEOSGeometry} GEOSGeometry*
   ...
   * Construct an STRtree from items that have been inserted. Once constructed, no more items may be inserted into the tree. Functions that require a constructed tree will build it automatically, so there is no need to call GEOSSTRtree_build unless it is desired to explicitly construct the tree in a certain section of code or using a certain thread.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSSTRtree} tree - undefined
   * @returns {number} 1 on success, 0 on error
   * @alias module:geos
   */
   ...
   * Create a new GEOSSTRtree using the Sort-Tile-Recursive algorithm (STRtree) for two-dimensional spatial data.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {number} nodeCapacity - undefined
   * @returns {GEOSSTRtree} a pointer to the created tree
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSSTRtree} tree - undefined
   * @param {GEOSQueryCallback} callback - undefined
   * @param {Pointer} userdata - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * @param {GEOSSTRtree} tree - undefined
   * @param {Pointer} item - undefined
   * @param {GEOSGeometry} itemEnvelope - undefined
   * @param {GEOSDistanceCallback} distancefn - undefined
   * @param {Pointer} userdata - undefined
   * @returns {number} a const pointer to the nearest item in the tree to item, or NULL in case of exception
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} extHandle - undefined
   * @param {GEOSGeometry} g - undefined
   * @param {GEOSGeometry} env - undefined
   * @param {number} tolerance - undefined
   * @param {number} flags - undefined
   * @returns {GEOSGeometry} A newly allocated geometry. NULL on exception. Caller is responsible for freeing with GEOSGeom_destroy().
   * @alias module:geos
   ...
   * Free the memory associated with a GEOSWKBReader.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSWKBReader} reader - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * Free the memory associated with a GEOSWKBWriter.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSWKBWriter} writer - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSWKBWriter} writer - undefined
   * @param {number} writeSRID - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSWKBWriter} writer - undefined
   * @param {number} newDimension - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * Free the memory associated with a GEOSWKTReader.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSWKTReader} reader - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * Free the memory associated with a GEOSWKTWriter.
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSWKTWriter} writer - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSWKTWriter} writer - undefined
   * @param {number} useOld3D - undefined
   * @returns {null} void
   * @alias module:geos
   */
   ...
   * @param {GEOSContextHandle_t} handle - undefined
   * @param {GEOSWKTWriter} writer - undefined
   * @param {number} precision - undefined
   * @returns {null} void
   * @alias module:geos
   */
